...
return check;
	...
	public String  check_Balance1(int Acc_no)// This function is used to check the balance in Account
	{
		int counter = 0;
		String oldbalance="";
		String A_no = String.valueOf(Acc_no);
	...
	public boolean Calculate_Interest(int Acc_no)// This function is used to calculate the interest
	{
		int counter = 0;
		String oldbalance;
