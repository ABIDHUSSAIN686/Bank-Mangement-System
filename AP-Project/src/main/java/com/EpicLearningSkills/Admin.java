...
public class Admin extends Bank_System {
    ...
    void get_approval_of_Account() // Admin can open a New Account and close an account
    {
    ...
    void calculate_interest_Admin(int Account_no) {    // Specify the Interest Rate, applicable to all Saving Accounts
        setAccountno(Account_no);
